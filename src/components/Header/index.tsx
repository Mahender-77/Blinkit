  ...
  return (
    ...
    >
      ...
      >
        ...
        />
        <span className={`placeholder-text ${animationClass}`}>{placeholder}</span>
        </Box>
      </Box>
...
{/* <div style={{ display: "flex", justifyContent: "center", marginTop: "50px" }}>
      ...
      <Button sx={{backgroundColor:"green",color:"white",height:"50px",fontWeight:"bold"}}><ShoppingCartCheckoutIcon sx={{marginRight:"8px"}}/>My Cart</Button>
    </Box>
  );
};
